  ...
  data() {
    return {
      ...
      form: {
        sourceSubUrl: "",
        clientType: "",
        customBackend: this.getUrlParam() == "" ? "" : this.getUrlParam(),
        remoteConfig: "https://gist.githubusercontent.com/imoyy/69535f6490b30fa3436ae06234b10c56/raw/config.ini",
        excludeRemarks: "",
        includeRemarks: "",
        filename: "",
        rename: "",
